...
#define nl1 ch_pos = ch_start;  ch_pos.y -= .0;
#define nl2 ch_pos = ch_start;  ch_pos.y -= 3.0;
#define nl3 ch_pos = ch_start;	ch_pos.y -= 6.0;
#define nl4 ch_pos = ch_start;	ch_pos.y -= 9.0;
