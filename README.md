...
- ["La bataille de Sales Bières](https://github.com/heaspery/la-bataille-de-salesbieres) et son [archive]() : une visual novel éducative basée sur la littérature française médiévale par Mathilde Ançay, jouable sur [itch.io](https://heaspery.itch.io/la-bataille-de-salesbieres)
